...
public class ServerQualityTest {
	...
	// }
	//
	// totalTime = (double) ((double) (OptimistPrimeBot.getEndTime() -
	// OptimistPrimeBot
	...
	// + server.getAvgRequestProcessTime() + " milliseconds per request");
	// }
